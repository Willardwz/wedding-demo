...
//替换照片处
    var imgArr = ["images/小飞机爆炸.gif","images/我的飞机.gif"];//图片路径数组
    var index = Math.floor((Math.random()*imgArr.length));//随机下标，保证随机的数字在数组中能取到
    var imagesrc = imgArr[index];//随机获取的图片路径
    plan.call(this,1,X,Y,66,80,0,660,0,"images/我的飞机.gif",imagesrc);
...
var bianjie=function(){
    ...
    if(bodyobjX<405||bodyobjX>815||bodyobjY<0||bodyobjY>568){
        if(document.removeEventListener){
            mainDiv.removeEventListener("mousemove",yidong,true);
        }
        else if(document.detachEvent){
...
function start(){
    ...
    if(mark==20){
        if(ourPlan.imagesrc == (["images/小飞机爆炸.gif"])){
            mark1++;
            //中飞机
            if(mark1%5==0){
                enemys.push(new enemy(6,25,274,46,60,5000,360,random(1,3),"images/我的飞机.gif","images/我的飞机.gif"));
            }
            //大飞机
            if(mark1==20){
                enemys.push(new enemy(12,57,210,110,164,30000,540,1,"images/我的飞机.gif","images/我的飞机.gif"));
                mark1=0;
            }
            //小飞机
            else{
                enemys.push(new enemy(1,19,286,34,24,1000,360,random(1,4),"images/我的飞机.gif","images/我的飞机.gif"));
            }
            mark=0;
        }
        else{
            ...
            //中飞机
            if(mark1%5==0){
                enemys.push(new enemy(6,25,274,46,60,5000,360,random(1,3),"images/小飞机爆炸.gif","images/小飞机爆炸.gif"));
            }
            //大飞机
            if(mark1==20){
                enemys.push(new enemy(12,57,210,110,164,30000,540,1,"images/小飞机爆炸.gif","images/小飞机爆炸.gif"));
                mark1=0;
            }
            //小飞机
            else{
                enemys.push(new enemy(1,19,286,34,24,1000,360,random(1,4),"images/小飞机爆炸.gif","images/小飞机爆炸.gif"));
            }
            mark=0;
        }
    }
